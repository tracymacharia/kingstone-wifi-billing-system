# ============================================
# Kingstone WiFi Billing System - HOTSPOT Configuration
# ============================================
...
# 3. In Terminal: /system script run admin-hotspot.rsc
# ============================================
...
/ip dhcp-server add address-pool=[ADDRESS_POOL] disabled=no interface=bridge-hotspot lease-time=1h name=dhcp-hotspot
...
/ip hotspot add address-pool=[ADDRESS_POOL] disabled=no interface=bridge-hotspot name=hotspot1 profile=hotspot-profile
