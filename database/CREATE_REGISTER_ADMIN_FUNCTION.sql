-- ============================================
-- CREATE: register_admin_simple RPC function
-- Alternative to the missing Edge Function
-- ============================================
...
COMMENT ON FUNCTION register_admin_simple IS 'Register a new admin under an owner. Requires valid owner session token.';
